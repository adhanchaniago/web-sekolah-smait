                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="contact-address">
                                 <h3>Contoh Pengisian Formulir Pendaftaran</h3>
                                <form >
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="Maulana Agung Pangesu" disabled>
                                    </div>
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                                        <input type="email" class="form-control" value="maulana.agung@raharja.info" disabled="">
                                    </div>
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="085888241172" disabled="">
                                    </div>
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="Farmasi" disabled>
                                    </div>
                                    <!-- // end .form-group -->
